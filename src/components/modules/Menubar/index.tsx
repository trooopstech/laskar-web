...
const Menubar = () => {
  ...
  return (
    <div className="p-2 h-full bg-gray-800 shadow">
      ...
      <div
        className="w-12 h-12 bg-gray-600 rounded-md hover:bg-red-400 shadow-sm cursor-pointer flex items-center justify-center mt-2"
        onClick={openCreateClass}
      >
        <MdAddCircle style={{ fontSize: "32px" }} />
      </div>
      <CreateClassModal open={isCreateClassOpen} onClose={closeCreateClass} />
    </div>
  );
};
